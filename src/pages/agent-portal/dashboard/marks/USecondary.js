...
function USecondary(props) {
  ...
  const readAllRecords =  () => {
    ...
    axios.post(`${BaseUrl}/lockpostadd/getStudentSecondaryMarks`, body)
      .then((res) => {
        // callalert(res, "then");
  ...
  const handleSubmit = async (event) => {
      ...
      if (
        ...
        console.log(body)   
          axios.post(`${BaseUrl}/lockpostadd/UpdateSecondaryMarks`, body)
            .then((res) => {
             callalert(res, "then");
            })
            .catch((err) => {
  ...
  return (
    <div>
         <Typography
              ...
              style={{ color: "blue" }}
            >
              <h2>Update {props.getSubCategoryid3} Secondary Class Marks</h2>
            </Typography>
