...
function SrSecondary_Marksheet(props) {
...
let strSupplementry =""
			...
			if(props.location.res.science >=33 && props.location.res.science<=74){
				setScience(props.location.res.science)
			}else if(props.location.res.science >=75 && props.location.res.science<=100){
				setScience(props.location.res.science+" Dist")
			}else {
				setScience(props.location.res.science+" F")
				countSupplementry++;
				strSupplementry = strSupplementry + " Science ,"
			}


			if(props.location.res.soscience >=33 && props.location.res.soscience<=74){
				setSoscience(props.location.res.soscience)
			}else if(props.location.res.soscience >=75 && props.location.res.soscience<=100){
				setSoscience(props.location.res.soscience+" Dist")
			}else {
				setSoscience(props.location.res.soscience+" F")
				countSupplementry++;
				strSupplementry = strSupplementry + " SoScience ,"
			}



			if(props.location.res.sanskrit >=33 && props.location.res.sanskrit<=74){
				setSanskrit(props.location.res.sanskrit)
			}else if(props.location.res.sanskrit >=75 && props.location.res.sanskrit<=100){
				setSanskrit(props.location.res.sanskrit+" Dist")
			}else {
				setSanskrit(props.location.res.sanskrit+" F")
				strSupplementry = strSupplementry + " Sanskrit ,"
			}
		...
		let totalmarks = props.location.res.hindi + props.location.res.english + props.location.res.science +props.location.res.soscience +props.location.res.sanskrit +props.location.res.maths
		...
		if(props.location.res.class == "9"){
			setClass("9th")
		}else if(props.location.res.class == "10"){
			setClass("10th")
		}
		...
		let body={
			session:props.location.res.session,
	...
	// console.log("Data For Rank ",result)
		...
		axios.post(`${BaseUrl}/lockpostadd/GetRankForSrSecondaryStudent`, body)
        .then((res) => {
				...
				<div className="stl_view">
					<div className="stl_05 stl_06">
						...
						<div className="stl_01" style={{ left: "12.2em", top: "25.2335em" }}>
							...
							{/* <span className="stl_32 stl_11 stl_28" style={{ "word-spacing": "-0.0062em" }}>
								&nbsp;
							</span>
							<span className="stl_32 stl_11 stl_20" style={{ "word-spacing": "-0.0019em" }}>
								Kamachha Varanasi &nbsp;
							</span> */}
						</div>
...
{/* 
						...
						<div className="stl_01" style={{ left: "42.8083em", top: "42.2952em" }}>
							<span className="stl_32 stl_11 stl_55">
								{getTotalmarks} &nbsp;
							</span>
						</div> */}
						...
						<div className="stl_01" style={{ left: "6.820em", top: "33.4654em" }}>
							<span className="stl_52 stl_11 stl_49">
								ENGLISH &nbsp;
							</span>
						</div>
						...
						<div className="stl_01" style={{ left: "6.182em", top: "37.897em" }}>
						...
						<div className="stl_01" style={{ left: "6.582em", top: "40.827em" }}>
...
{/* ////////////////////////////////////////////////////////////////////// */}
						...
						<div className="stl_01" style={{ left: "19.152em", top: "45.2328em" }}>
							...
							{/* <span className="stl_58 stl_11 stl_28" style={{ "word-spacing": "-0.0187em" }}>
								–
							</span><span className="stl_26 stl_11 stl_45" style={{ "word-spacing": "0.0006em" }}>
								1 [ On A 3-Point (A-C) Grading Scale] &nbsp;
							</span> */}
						</div>
...
export default SrSecondary_Marksheet;