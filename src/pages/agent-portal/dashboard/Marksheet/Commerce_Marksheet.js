...
function Commerce_Marksheet(props) {
	...
	// one extra subject row, so when IT is shown it only needs a normal 1-row
	// nudge to follow it directly, not another full row-gap on top.
	const rowShift = hasIt ? 0.02 : 0;
