...
import './tc.css';
import backgroud from './img/backgroud1.png';
...
{/* 
                ...
                <div className="tc stl_view">
                    <div className="tc stl_05 stl_06">
                        ...
                        >
                            ...
                            >
                                {getSchoolBoardResult} &nbsp;
                                      ...
                                      <div
                            className="tc stl_01 stl_07"
                            style={{ left: "5.9063em", top: "47.1317em" }}
                        >
                            <span
                        ...
                        <div
                            className="tc stl_01 stl_07"
                            style={{ left: "15.9063em", top: "47.1317em" }}
                        >
                            <span
                                className="tc stl_17 stl_09 stl_33"
                                style={{ "word-spacing": "0.0005em" }}
                        ...
                        <div
                            className="tc stl_01 stl_07"
                            style={{ left: "26.9063em", top: "47.1317em" }}
                        >
                            <span
                                className="tc stl_17 stl_09 stl_33"
                                style={{ "word-spacing": "0.0005em" }}
                        ...
                        <div
                            className="tc stl_01 stl_07"
                            style={{ left: "37.9063em", top: "47.1317em" }}
                        >
                            <span
                                className="tc stl_17 stl_09 stl_33"
                                style={{ "word-spacing": "0.0005em" }}
